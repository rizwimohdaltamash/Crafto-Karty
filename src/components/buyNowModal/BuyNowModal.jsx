    ...
    return (
        <>
            <button
                // type="button"
                // onClick={handleOpen}
                // className="w-full px-4 py-3 text-center text-gray-100 bg-orange-900 border border-transparent dark:border-gray-700 hover:border-orange-500  hover:bg-orange-700 rounded-xl"
                type="button"
                onClick={() => {
                    handleClickEffect();
                    handleOpen();
                    ...
                    <div className="bg-gray-900 p-6 rounded-xl shadow-lg">
                        ...
                        <div className="flex justify-between">
                            ...
                            <button
                                ...
                                className="px-4 py-2 text-orange-900 rounded-lg"
                            >
                                Pay now
                            </button>
                        </div>
