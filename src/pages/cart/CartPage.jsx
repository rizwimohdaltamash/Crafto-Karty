...
const CartPage = () => {
 ...
 // Decrement item quantity
  ...
  // useEffect(() => {
  //   const storedCart = localStorage.getItem(`${userPrefix}cart`);
  //   if (storedCart) {
  //     const parsedCart = JSON.parse(storedCart);
  //     // Dispatch action to load cart into Redux store if needed
  //   }
  // }, [userPrefix]);

  // Save cart data for the current user
  // useEffect(() => {
  //   localStorage.setItem(`${userPrefix}cart`, JSON.stringify(cartItems));
  // }, [cartItems, userPrefix]);
    ...
    script.onload = async () => {
      const options = {
        ...
        handler:async function (response) {
          ...
          // Clear the cart after the success toast
          // cartItems.forEach((item) => {
          //   dispatch(deleteFromCart(item));
          // });

          // Navigate to another page after clearing the cart
          // navigate("/");
            ...
            >
              ...
              <ul role="list" className="divide-y divide-gray-200">
                {cartItems.length > 0 ? (
                  ...
                  <div>
                    <div>
                      <h1 className="text-orange-700 font-bold text-xl mt-4">
                        Cart Is Empty
                      </h1>
                      <img
                        src={EmptyCart}
                      ...
                      <div>
                        {cartItems.length > 0 ? (
                          ...
                          <div
                            ...
                            className="bg-orange-700 hover:bg-orange-500 text-white cursor-pointer px-4 py-2 rounded"
