              ...
              <div className="flex flex-wrap mb-24 -mx-4">
                <div className="w-full px-4 mb-8 md:w-1/2 md:mb-0 ">
                  <div className="">
                    <div className="">
                      {/* <img
                                                className=" w-full lg:h-[35em] rounded-lg"
                      ...
                      className="z-0 w-full lg:h-[80%] rounded-lg "
                    >
                      {product?.productImageUrl?.map((image, index) => (
                    ...
                    <div className="flex flex-wrap items-center mb-6">
                      {cartItems.some((p) => p.id === product.id) ? (
                        <button
                          ...
                          className="w-full px-4 py-3 text-center text-white bg-orange-900 border border-orange-600  hover:bg-orange-800 hover:text-gray-100  rounded-xl"
                        >
                          Delete to cart
                        </button>
                      ) : (
